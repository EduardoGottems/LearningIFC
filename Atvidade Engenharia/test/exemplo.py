...
class TestConversao(unittest.TestCase):
    ...
    def test_binarioToDecimal(self):
        self.assertEquals(Conversao.binario_para_decimal_ipv4("11111111.11111111.11111111.11111111"),"255.255.255.255")
        self.assertEquals(Conversao.binario_para_decimal_ipv4("00000000.00000000.00000000.00000000"),"0.0.0.0")
        print("Binario para decimal ok!")

    def test_decimalToBinario(self):
        self.assertEquals(Conversao.decimal_para_binario_ipv4("255.255.255.255"),"11111111.11111111.11111111.11111111")
        self.assertEquals(Conversao.decimal_para_binario_ipv4("0.0.0.0"),"00000000.00000000.00000000.00000000")
